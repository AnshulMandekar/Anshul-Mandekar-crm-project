                ...
                <form className="space-y-8" onSubmit={handleSubmit}>
                    ...
                    <div className="bg-white shadow rounded-lg p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Area of Land (sq ft)</label>
                                <input
                                    type="number"
                                    name="areaOfLand"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Geo Tag of Land</label>
                                <input
                                    type="text"
                                    name="geoTag"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Type of Building</label>
                                <select
                                    name="typeOfBuilding"
                    ...
                    <div className="bg-white shadow rounded-lg p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Total Number of Floors</label>
                                <input
                                    type="number"
                                    name="totalFloors"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Floor Space Index (FSI)</label>
                                <input
                                    type="number"
                                    name="fsi"
                                    value={formData.fsi}
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Super Built-up Area</label>
                                <input
                                    type="number"
                        ...
                        <div className="mt-6">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                {['Studio', '1 BHK', '1.5 BHK', '2 BHK', '2.5 BHK', '3 BHK', '4 BHK', 'Row House', 'Villa'].map((unitType) => (
                    ...
                    <div className="bg-white shadow rounded-lg p-6">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            <div className="border p-4 rounded">
                                <h3 className="font-medium mb-2">Customizable Payment Schedule</h3>
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        />
                                        <button type="button" className="text-custom hover:text-custom/80">+ Add Stage</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white shadow rounded-lg p-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                            {['Swimming Pool', 'Gym', 'Lounge', 'Parking', 'Garden', 'Club House', 'Kids Play Area', 'Security', 'Power Backup', 'Sports Court'].map((amenity) => (
                    ...
                    <div className="bg-white shadow rounded-lg p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Society Formation Fees</label>
                                <input
                                    type="number"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Development Charges</label>
                                <input
                                    type="number"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Legal Charges</label>
                                <input
                                    type="number"
                                    name="legalCharges"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Maintenance (per sq ft)</label>
                                <input
                                    type="number"
                                    name="maintenance"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Stamp Duty</label>
                                <input
                                    type="number"
                                    name="stampDuty"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Registration Charges</label>
                                <input
                                    type="number"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Infrastructure Charges</label>
                                <input
                                    type="number"
                    ...
                    <div className="bg-white shadow rounded-lg p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                'IOD Document', 'CC Document', 'NA Document', 'Purchase Deed', 'RERA Certificate', 'Approved Plans',
                                'Title Documents', 'Fire NOC', 'Tree NOC', 'PWD Approval', 'Environment Clearance',
                                'Airport Authority Approval', 'Traffic NOC', 'Project Brochure', 'Building Stage Documents', 'Updated ASR Rate Document'
                            ].map((document) => (
                                <div key={document}>
                    ...
                    <div className="flex justify-end">
                        <button
                            type="submit"
                            className="bg-custom text-white px-6 py-2 !rounded-button hover:bg-custom/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-custom"
                        >
